# Generated by Django 4.2.10 on 2024-02-19 05:53
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('first_name', 'last_name', 'disambiguator'), name='unique_instructor'),
        ),
        migrations.AddConstraint(
        ...
        migrations.AddConstraint(
            model_name='student',
            constraint=models.UniqueConstraint(fields=('first_name', 'last_name', 'disambiguator'), name='unique_student'),
        ),
    ]
